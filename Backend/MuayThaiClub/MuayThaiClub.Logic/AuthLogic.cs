...
namespace MuayThaiClub.Logic
{
  public class AuthLogic : IAuthLogic
  {
    ...
    public async Task<AuthLoginResultDto> Login(AuthLoginDto UserLogin)
    {
    ...
    public async Task Register(AuthRegisterDto user)
    {
      ...
      var UserEntity = new User { AppUserID = NewUser.Id, DateOfBirth = NewUser.DateOfBirth };
      await repo.CreateAsync(UserEntity);
    }
